...
RUN set -ex; \
    apt-get update; \
    apt-get install -y ffmpeg wkhtmltopdf tesseract-ocr-ind libleptonica-dev python3.9 libtesseract-dev libwebp6 libwebp-dev libwebpdemux2 libwebpmux3 python-zbar wget unzip iputils-ping python3-pip webp iputils-ping jp2a 
